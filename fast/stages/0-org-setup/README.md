...
- [GitHub CI/CD Setup (PowerShell)](#github-cicd-setup-powershell)
  - [1. Update the Stage 0 CI/CD dataset files](#1-update-the-stage-0-cicd-dataset-files)
  - [2. Apply Stage 0 so GCP creates the WIF provider and bindings](#2-apply-stage-0-so-gcp-creates-the-wif-provider-and-bindings)
  - [3. Verify the generated provider files](#3-verify-the-generated-provider-files)
  - [4. Create the GitHub Actions workflows](#4-create-the-github-actions-workflows)
  - [5. Commit and push the CI/CD configuration](#5-commit-and-push-the-cicd-configuration)
  - [6. Test the plan workflow](#6-test-the-plan-workflow)
  - [7. Test the apply workflow](#7-test-the-apply-workflow)
